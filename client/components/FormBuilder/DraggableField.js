...
import {white, lightGray, red, brandyRose} from '../../shared/styles'
                ...
                >
                  <Wrapper>
                    <LabelEditWrapper>
                      <span>{label}</span>
                      <EditButton
                        onClick={event => handleEditFieldClick(event, index)}
                      >
                        Edit
                      </EditButton>
                      {!isRequiredField(draggableId) && (
                        <TrashCan
                          onClick={() => handleDeleteField(draggableId)}
                          height="40px"
